...
import registryRecord_150 from "../../content/registry/datasets/deepseek-v4-specialist-corpus.json";
import registryRecord_151 from "../../content/registry/organizations/deepseek-ai.json";
import registryRecord_152 from "../../content/registry/citations/attention-is-all-you-need.json";
import registryRecord_153 from "../../content/registry/citations/awq.json";
import registryRecord_154 from "../../content/registry/citations/batch-normalization.json";
import registryRecord_155 from "../../content/registry/citations/brown-gpt-3.json";
import registryRecord_156 from "../../content/registry/citations/chen-positional-interpolation.json";
import registryRecord_157 from "../../content/registry/citations/classifier-free-diffusion-guidance.json";
import registryRecord_158 from "../../content/registry/citations/curious-case-neural-text-degeneration.json";
import registryRecord_159 from "../../content/registry/citations/deepseek-v2-mla-paper.json";
import registryRecord_160 from "../../content/registry/citations/deepseek-v4-paper.json";
import registryRecord_161 from "../../content/registry/citations/denoising-diffusion-probabilistic-models.json";
import registryRecord_162 from "../../content/registry/citations/ding-longrope.json";
import registryRecord_163 from "../../content/registry/citations/flamingo-visual-language-model.json";
import registryRecord_164 from "../../content/registry/citations/glu-variants-improve-transformer.json";
import registryRecord_165 from "../../content/registry/citations/goodfellow-deep-learning.json";
import registryRecord_166 from "../../content/registry/citations/gpt-2-report.json";
import registryRecord_167 from "../../content/registry/citations/gqa-paper.json";
import registryRecord_168 from "../../content/registry/citations/group-normalization.json";
import registryRecord_169 from "../../content/registry/citations/image-is-worth-16x16-words.json";
import registryRecord_170 from "../../content/registry/citations/kaiokendev-superhot.json";
import registryRecord_171 from "../../content/registry/citations/kaplan-scaling-laws.json";
...
const datasetRecords: DatasetRecord[] = [
  datasetRecordSchema.parse(registryRecord_150),
];

const organizationRecords: OrganizationRecord[] = [
  organizationRecordSchema.parse(registryRecord_151),
];

const citationRecords: CitationRecord[] = [
  citationRecordSchema.parse(registryRecord_152),
