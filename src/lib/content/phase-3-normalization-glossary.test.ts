...
describe("Phase 3 normalization glossary page (US-004)", () => {
  ...
  test("curated related links transformer architecture and planned residual connection", () => {
    ...
    expect(residual?.isPlanned).toBe(true);
    expect(residual?.href).toBeUndefined();
  });
