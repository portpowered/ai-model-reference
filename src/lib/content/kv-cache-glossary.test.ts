...
describe("Phase 5 KV cache glossary page (US-001)", () => {
  ...
  test("page renders serving tradeoff copy, links to prefill and decode search handoffs, and related attention pages", async () => {
    ...
    expect(html).toContain("cost real money to serve");
    expect(html).toContain('href="/search?q=prefill"');
