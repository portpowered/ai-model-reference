 ...
 * (`make ci` already runs `make internal-typecheck` before `make test`).
 */
...
/** Bun test ceiling for isolated worktree install + `make internal-typecheck` under full-suite load. */
