...
export const typedTaxonomyConsumerAuditContract: readonly TypedTaxonomyConsumerContractEntry[] =
  [
    ...
    },
    {
      ...
      rationale:
        "Module, training, and system sidebar subgroup placement now resolves through canonical classification membership first and confines the remaining customer-visible exceptions to explicit sidebarGrouping editorial overrides.",
    },
    {
