---
title: "Scaling Law"
description: "Empirical power-law relationships between model scale, compute, data, and downstream loss or capability—used to forecast training budgets and benchmark trends."
kind: "glossary"
...
<TagPillList registryId="concept.scaling-law" />
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.scaling-law" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.scaling-law" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.scaling-law" />
</Section>
