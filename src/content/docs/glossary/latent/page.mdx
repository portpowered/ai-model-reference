---
title: "Latent"
description: "A compressed internal code that summarizes input structure for reconstruction, generation, or downstream tasks."
kind: "glossary"
...
<TagPillList registryId="concept.latent" />
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.latent" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.latent" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.latent" />
</Section>
