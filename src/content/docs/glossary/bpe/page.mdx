---
title: "BPE"
description: "Byte-pair encoding merges frequent symbol pairs into subword tokens until a target vocabulary size is reached."
kind: "glossary"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.bpe" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.bpe" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.bpe" />
</Section>
