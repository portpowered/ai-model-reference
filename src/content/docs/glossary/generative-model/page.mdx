...
description: A model trained to produce new outputs such as text, images, or audio rather than only assign labels to fixed categories.
kind: "glossary"
...
<TagPillList registryId="concept.generative-model" />
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.generative-model" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.generative-model" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.generative-model" />
</Section>
