---
title: "SentencePiece"
description: "A tokenizer library and model format that trains BPE or Unigram vocabularies with whitespace handled inside the learned pieces."
kind: "glossary"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.sentencepiece" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.sentencepiece" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.sentencepiece" />
</Section>
