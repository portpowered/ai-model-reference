---
title: "LongRoPE"
description: "RoPE extension that searches for per-frequency scaling factors so decoders reach very long context with limited fine-tuning cost."
kind: "glossary"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.longrope" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.longrope" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.longrope" />
</Section>
