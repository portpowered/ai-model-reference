---
title: Loss Function
description: A scalar score that measures how wrong the model's predictions are so training knows which direction to improve.
kind: "glossary"
...
<TagPillList registryId="concept.loss-function" />
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.loss-function" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.loss-function" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.loss-function" />
</Section>
