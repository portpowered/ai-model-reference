---
title: "Batch norm"
description: "Normalization that rescales activations using mean and variance pooled across the batch dimension—common in vision CNNs but rare inside decoder transformer stacks."
kind: "glossary"
