---
title: "WordPiece"
description: "A subword tokenizer that scores candidate merges by likelihood, famously used in BERT-family encoders."
kind: "glossary"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.wordpiece" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.wordpiece" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.wordpiece" />
</Section>
