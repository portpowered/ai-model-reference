...
description: A large pretrained model intended as a shared starting point for many downstream tasks via fine-tuning or prompting.
kind: "glossary"
...
<TagPillList registryId="concept.foundation-model" />
...
<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.foundation-model" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.foundation-model" />
</Section>
