---
title: "SuperHOT RoPE"
description: "RoPE extension that rescales frequency bases so a model trained on shorter context can attend across longer sequences with limited fine-tuning."
kind: "glossary"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.superhot-rope" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.superhot-rope" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.superhot-rope" />
</Section>
