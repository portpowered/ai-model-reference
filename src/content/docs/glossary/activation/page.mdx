---
title: Activation
description: The numeric output of a layer after its linear transform and nonlinearity, passed forward through the network.
kind: "glossary"
...
<TagPillList registryId="concept.activation" />
