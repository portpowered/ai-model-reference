...
description: "RoPE base adjustment inspired by neural tangent kernel theory—rescales frequencies so rotary angles stay usable when context length grows past pretraining."
kind: "glossary"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.ntk-aware-rope-scaling" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.ntk-aware-rope-scaling" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.ntk-aware-rope-scaling" />
</Section>
