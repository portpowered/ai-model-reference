---
title: Embedding
description: A dense vector that represents a token or other discrete item so the model can run continuous math on it.
kind: "glossary"
...
<TagPillList registryId="concept.embedding" />
