---
title: Model
description: A trained machine learning system that maps inputs to outputs using learned parameters.
kind: "glossary"
...
<TagPillList registryId="concept.model" />
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.model" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.model" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.model" />
</Section>
