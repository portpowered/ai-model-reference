...
description: "An interaction pattern where positions in one sequence attend to keys and values drawn from a different sequence, usually encoder memory feeding a decoder."
kind: "concept"
