...
description: "A layout where one bidirectional stack reads the full input and emits contextual representations without a separate autoregressive decoder."
kind: "concept"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.encoder-only-architecture" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.encoder-only-architecture" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.encoder-only-architecture" />
</Section>
