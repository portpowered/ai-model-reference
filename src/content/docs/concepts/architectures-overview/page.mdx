...
description: "How major model families differ in how they read inputs, mix information, and produce outputs."
kind: "concept"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.architectures-overview" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.architectures-overview" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.architectures-overview" />
</Section>
