...
description: "Self-attention without a causal mask, so each position may attend to both earlier and later tokens in the same sequence."
kind: "concept"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.bidirectional-attention" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.bidirectional-attention" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.bidirectional-attention" />
</Section>
