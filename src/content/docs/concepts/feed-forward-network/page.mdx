...
description: The broad transformer-block concept for the per-token layer that adds nonlinear processing after attention.
kind: "concept"
...
<Section id="common-confusions" titleKey="sections.commonConfusions.title">
  ...
  <div className="mt-4">
    <RegistryLinkList
      ...
      emptyLabel="No nearby docs available."
    />
  </div>
</Section>
