...
description: "A layout with a bidirectional encoder that reads the full input and a causal decoder that generates outputs while cross-attending to encoder memory."
kind: "concept"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="concept.encoder-decoder-architecture" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="concept.encoder-decoder-architecture" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="concept.encoder-decoder-architecture" />
</Section>
