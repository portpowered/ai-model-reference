---
title: Phi
description: A small-model line from Microsoft that is often used to show how data quality and compact deployment can matter as much as raw parameter count.
kind: "model"
registryId: "model.phi"
...
<ModelAtAGlance registryId="model.phi" />
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.phi" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.phi" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.phi" />
</Section>
