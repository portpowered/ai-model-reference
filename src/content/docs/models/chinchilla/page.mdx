---
title: Chinchilla
description: A decoder-only Transformer checkpoint from DeepMind that became the clearest public example of compute-optimal language-model scaling.
kind: "model"
registryId: "model.chinchilla"
...
<ModelAtAGlance registryId="model.chinchilla" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.chinchilla" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.chinchilla" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="model.chinchilla" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.chinchilla" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.chinchilla" />
</Section>
