---
title: Mixtral
description: A sparse mixture-of-experts model line from Mistral AI that keeps a decoder-only language-model shape while routing tokens through selected experts.
kind: "model"
registryId: "model.mixtral"
...
<ModelAtAGlance registryId="model.mixtral" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.mixtral" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.mixtral" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.mixtral" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.mixtral" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.mixtral" />
</Section>
