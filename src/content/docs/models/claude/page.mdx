---
title: Claude
description: A frontier Anthropic model line centered on assistant behavior, alignment, and increasingly multimodal and tool-using workflows.
kind: "model"
registryId: "model.claude"
...
<ModelAtAGlance registryId="model.claude" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.claude" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.claude" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.claude" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.claude" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.claude" />
</Section>
