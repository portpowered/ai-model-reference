---
title: Qwen3
description: A frontier Qwen release line that spans dense and mixture-of-experts checkpoints while staying inside the broader decoder-only Transformer pattern.
kind: "model"
registryId: "model.qwen3"
...
<ModelAtAGlance registryId="model.qwen3" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.qwen3" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.qwen3" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.qwen3" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.qwen3" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.qwen3" />
</Section>
