---
title: OLMo
description: A truly open language-model line from Ai2 that released weights, training data, code, and intermediate artifacts for research use.
kind: "model"
registryId: "model.olmo"
...
<ModelAtAGlance registryId="model.olmo" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.olmo" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.olmo" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.olmo" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.olmo" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.olmo" />
</Section>
