---
title: Codestral
description: Mistral's code model line for code generation and completion, with a more direct focus on developer tasks than the general Mistral checkpoints.
kind: "model"
registryId: "model.codestral"
...
<ModelAtAGlance registryId="model.codestral" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.codestral" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.codestral" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.codestral" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.codestral" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.codestral" />
</Section>
