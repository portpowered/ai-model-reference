---
title: OPT
description: Meta's Open Pre-trained Transformer line, published to give researchers a GPT-style model family with weights and training details they could inspect.
kind: "model"
registryId: "model.opt"
...
<ModelAtAGlance registryId="model.opt" />
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.opt" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.opt" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.opt" />
</Section>
