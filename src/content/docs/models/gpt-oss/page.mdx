---
title: GPT-OSS
description: An open-weight OpenAI checkpoint line that brings GPT-style language modeling back into a self-hosted, local-inference-friendly deployment story.
kind: "model"
registryId: "model.gpt-oss"
...
<ModelAtAGlance registryId="model.gpt-oss" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.gpt-oss" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.gpt-oss" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.gpt-oss" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.gpt-oss" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.gpt-oss" />
</Section>
