...
description: A DeepSeek code-model line aimed at repository-scale completion, infilling, and software engineering tasks.
kind: "model"
registryId: "model.deepseek-coder"
...
<ModelAtAGlance registryId="model.deepseek-coder" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.deepseek-coder" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.deepseek-coder" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.deepseek-coder" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.deepseek-coder" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.deepseek-coder" />
</Section>
