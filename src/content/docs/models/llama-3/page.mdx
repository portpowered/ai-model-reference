---
title: Llama 3
description: Meta's open-weight Llama-family decoder-only transformer release, spanning dense and instruction-tuned checkpoints with long-context support.
kind: "model"
...
<Section id="architecture" titleKey="sections.architecture.title">
  ...
  <ModelArchitectureGraph registryId="model.llama-3" assetId="architectureGraph" />
</Section>
