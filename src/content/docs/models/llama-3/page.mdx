---
title: Llama 3
description: A modern open-weights Llama checkpoint line that kept the decoder-only Transformer recipe while becoming a common frontier reference for general-purpose language use.
kind: "model"
...
<ModelAtAGlance registryId="model.llama-3" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.llama-3" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.llama-3" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.llama-3" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.llama-3" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.llama-3" />
</Section>
