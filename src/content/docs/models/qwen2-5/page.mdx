---
title: Qwen2.5
description: A refined Qwen frontier checkpoint line that keeps the decoder-only family shape while pushing further on instruction following, long-form use, and specialized follow-on releases.
kind: "model"
registryId: "model.qwen2-5"
...
<ModelAtAGlance registryId="model.qwen2-5" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.qwen2-5" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.qwen2-5" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.qwen2-5" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.qwen2-5" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.qwen2-5" />
</Section>
