...
description: An open-weights latent diffusion model family that turns text prompts into images by denoising in a compressed latent space and decoding to pixels.
kind: "model"
...
<ModelAtAGlance registryId="model.stable-diffusion" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.stable-diffusion" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.stable-diffusion" />
</Section>
...
<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.stable-diffusion" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.stable-diffusion" />
</Section>
