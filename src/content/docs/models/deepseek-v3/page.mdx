---
title: DeepSeek-V3
description: A later DeepSeek frontier checkpoint that keeps the family's MoE and MLA identity while scaling the release into a stronger general language-model reference.
kind: "model"
registryId: "model.deepseek-v3"
...
<ModelAtAGlance registryId="model.deepseek-v3" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.deepseek-v3" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.deepseek-v3" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.deepseek-v3" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.deepseek-v3" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.deepseek-v3" />
</Section>
