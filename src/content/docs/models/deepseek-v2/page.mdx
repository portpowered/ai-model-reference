---
title: DeepSeek-V2
description: An efficiency-focused DeepSeek checkpoint line that made MoE design and Multi-head Latent Attention central to the family story.
kind: "model"
registryId: "model.deepseek-v2"
...
<ModelAtAGlance registryId="model.deepseek-v2" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.deepseek-v2" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.deepseek-v2" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.deepseek-v2" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.deepseek-v2" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.deepseek-v2" />
</Section>
