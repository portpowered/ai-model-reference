---
title: Qwen Coder
description: A code-specialized Qwen line that keeps broad language-model behavior while pushing harder on developer tasks and repository completion.
kind: "model"
registryId: "model.qwen-coder"
...
<ModelAtAGlance registryId="model.qwen-coder" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.qwen-coder" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.qwen-coder" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.qwen-coder" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.qwen-coder" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.qwen-coder" />
</Section>
