---
title: Mistral
description: An open-weight decoder-only Transformer line from Mistral AI that became known for strong capability at relatively compact sizes.
kind: "model"
registryId: "model.mistral"
...
<ModelAtAGlance registryId="model.mistral" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.mistral" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.mistral" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.mistral" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.mistral" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.mistral" />
</Section>
