---
title: PaLM
description: A decoder-only Transformer checkpoint from Google that pushed large-scale language-model scaling and few-shot behavior into the mainstream Pathways era.
kind: "model"
registryId: "model.palm"
...
<ModelAtAGlance registryId="model.palm" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.palm" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.palm" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="model.palm" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.palm" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.palm" />
</Section>
