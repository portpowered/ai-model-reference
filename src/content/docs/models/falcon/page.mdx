---
title: Falcon
description: An open decoder-only language-model series from the Technology Innovation Institute that became a major open reference at larger parameter scales.
kind: "model"
registryId: "model.falcon"
...
<ModelAtAGlance registryId="model.falcon" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.falcon" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.falcon" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  ...
  <RelatedDocs registryId="model.falcon" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="model.falcon" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="model.falcon" />
</Section>
