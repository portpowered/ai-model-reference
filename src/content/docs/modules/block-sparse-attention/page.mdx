...
description: How block-sparse attention groups tokens into blocks and computes attention only for selected query-block to key-block regions instead of every token pair.
kind: "module"
...
<ModuleAtAGlance registryId="module.block-sparse-attention" />
...
<Section id="how-it-works" titleKey="sections.howItWorks.title">
  ...
  <ModuleGraph registryId="module.block-sparse-attention" assetId="computeFlow" />
</Section>
...
<Section id="example-architectures" titleKey="sections.exampleArchitectures.title">
  ...
  <ModelsUsingModule registryId="module.block-sparse-attention" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="module.block-sparse-attention" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="module.block-sparse-attention" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="module.block-sparse-attention" />
</Section>
