...
description: How sliding-window attention limits each query to a fixed local neighborhood of keys instead of the full sequence used by dense multi-head attention.
kind: "module"
...
<ModuleAtAGlance registryId="module.sliding-window-attention" />
...
<Section id="example-architectures" titleKey="sections.exampleArchitectures.title">
  ...
  <ModelsUsingModule registryId="module.sliding-window-attention" />
</Section>
...
<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="module.sliding-window-attention" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="module.sliding-window-attention" />
</Section>
