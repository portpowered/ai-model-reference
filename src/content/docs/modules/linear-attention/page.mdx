...
description: How linear attention replaces explicit softmax dot-product attention with kernel or feature-map formulations that scale near-linearly with sequence length.
kind: "module"
...
<ModuleAtAGlance registryId="module.linear-attention" />
...
<Section id="example-architectures" titleKey="sections.exampleArchitectures.title">
  ...
  <ModelsUsingModule registryId="module.linear-attention" />
</Section>
...
<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="module.linear-attention" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="module.linear-attention" />
</Section>
