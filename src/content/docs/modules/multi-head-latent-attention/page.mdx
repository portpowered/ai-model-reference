...
description: How multi-head latent attention compresses KV cache storage while keeping multi-head query expressiveness.
kind: "module"
...
<Section id="example-architectures" titleKey="sections.exampleArchitectures.title">
  ...
  <ModelsUsingModule registryId="module.multi-head-latent-attention" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="module.multi-head-latent-attention" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="module.multi-head-latent-attention" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="module.multi-head-latent-attention" />
</Section>
