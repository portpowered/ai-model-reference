...
description: The process of turning images, audio, video, and other non-text inputs into token-like embeddings or sequences a shared model can process.
kind: "module"
registryId: "module.multimodal-tokenization"
...
<ModuleAtAGlance registryId="module.multimodal-tokenization" />
...
<Section id="math-or-compute-schema" titleKey="sections.mathOrComputeSchema.title">
  ...
  <ModuleAttentionSchemaComparison schemaIds={["modalityUnitSplit"]} />
</Section>
...
<Section id="example-architectures" titleKey="sections.exampleArchitectures.title">
  ...
  <ModelsUsingModule registryId="module.multimodal-tokenization" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="module.multimodal-tokenization" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="module.multimodal-tokenization" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="module.multimodal-tokenization" />
</Section>
