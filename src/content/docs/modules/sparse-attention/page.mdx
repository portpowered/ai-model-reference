...
description: How sparse attention limits which token pairs receive attention to reduce compute and memory versus dense multi-head attention.
kind: "module"
...
<Section id="example-architectures" titleKey="sections.exampleArchitectures.title">
  ...
  <ModelsUsingModule registryId="module.sparse-attention" />
</Section>
...
<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="module.sparse-attention" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="module.sparse-attention" />
</Section>
