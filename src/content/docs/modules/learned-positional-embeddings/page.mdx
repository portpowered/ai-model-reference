...
description: Learned positional embeddings train a position table alongside token embeddings, so each index gets a position vector the model can adapt during training.
kind: "glossary"
