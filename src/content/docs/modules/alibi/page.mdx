---
title: ALiBi
description: Attention with linear biases adds distance-based penalties to attention logits so models can extrapolate to longer sequences without explicit position embeddings.
kind: "module"
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="module.alibi" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="module.alibi" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="module.alibi" />
</Section>
