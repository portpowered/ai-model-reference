---
title: SentencePiece
description: SentencePiece learns subword pieces directly from raw text, which helps models tokenize many languages and scripts without depending on whitespace-first splitting.
kind: "module"
...
<ModuleAtAGlance registryId="module.sentencepiece" />
...
<Section id="how-it-works" titleKey="sections.howItWorks.title">
  ...
  <ModuleGraph registryId="module.sentencepiece" assetId="computeFlow" />
</Section>
...
<Section id="example-architectures" titleKey="sections.exampleArchitectures.title">
  ...
  <ModelsUsingModule registryId="module.sentencepiece" />
</Section>
...
<Section id="related" titleKey="sections.related.title">
  <RelatedDocs registryId="module.sentencepiece" />
</Section>

<Section id="tags" titleKey="sections.tags.title">
  <TagPillList registryId="module.sentencepiece" showDescriptions />
</Section>

<Section id="references" titleKey="sections.references.title">
  <CitationList registryId="module.sentencepiece" />
</Section>
