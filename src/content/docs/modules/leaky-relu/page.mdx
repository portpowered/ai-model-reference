...
description: An activation function that keeps a small negative slope instead of turning every negative value into zero.
kind: "module"
...
<ModuleAtAGlance registryId="module.leaky-relu" />
...
<Section id="example-architectures" titleKey="sections.exampleArchitectures.title">
  ...
  <ModelsUsingModule registryId="module.leaky-relu" />
</Section>
