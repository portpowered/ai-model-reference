...
<Section id="compared-to-nearby-regimes" titleKey="sections.comparedToNearbyRegimes.title">
  ...
  <LocalizedLinkList
    items={[
      { href: "/docs/glossary/alignment", labelKey: "links.alignment" },
      { href: "/search?q=RLHF", labelKey: "links.rlhf" },
      { href: "/search?q=PPO", labelKey: "links.ppo" },
      { href: "/search?q=GRPO", labelKey: "links.grpo" },
    ]}
  />
</Section>
