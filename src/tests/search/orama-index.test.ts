...
describe("exportOramaIndexSnapshot", () => {
  ...
  test.each([
    ...
    { query: "Mistral 7B", url: "/docs/models/mistral" },
    { query: "Mixtral 8x7B", url: "/docs/models/mixtral" },
    { query: "Google Gemma", url: "/docs/models/gemma" },
    { query: "Microsoft Phi", url: "/docs/models/phi" },
    { query: "Falcon LLM", url: "/docs/models/falcon" },
    { query: "Open Pre-trained Transformer", url: "/docs/models/opt" },
    { query: "Ai2 OLMo", url: "/docs/models/olmo" },
    { query: "code repair models", url: "/docs/models/code-repair-models" },
    { query: "Meta Code Llama", url: "/docs/models/code-llama" },
    { query: "BigCode StarCoder", url: "/docs/models/starcoder" },
    { query: "DeepSeek Coder", url: "/docs/models/deepseek-coder" },
    { query: "CodeQwen", url: "/docs/models/qwen-coder" },
    { query: "Codestral", url: "/docs/models/codestral" },
