...
<ModelAtAGlance registryId="model.example-model" />

<TagPillList registryId="model.example-model" />
...
<Section id="important-modules" titleKey="sections.importantModules.title">
  ...
  <ModelModuleList registryId="model.example-model" />
</Section>

<Section id="training" titleKey="sections.training.title">
  <T k="sections.training.body" />
  <ModelTrainingSummary registryId="model.example-model" />
</Section>
