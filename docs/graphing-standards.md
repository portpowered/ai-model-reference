...
* [docs writing standards](../factory/docs/standards/docs-writing-standards.md) — concise teaching tone, math vs narrative placement, and when graphs are required
