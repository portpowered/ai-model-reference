...
2. canonical content-runtime preparation through `bun run prepare:content-runtime`, including an immediate scoped drift proof for the tracked authoritative derived artifacts
...
proof. Unrelated repository cleanup is left to the maintainer rather than
